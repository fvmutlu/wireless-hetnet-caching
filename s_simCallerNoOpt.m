...
C_sc = R_cell^pathloss_exp; % Backhaul link cost for macro cell (TO DO: adjust this properly)
C_mc = 0.8*C_sc; % Backhaul link cost for small cells (TO DO: adjust this properly)
